...
wp_enqueue_style('kerge-main-styles', get_template_directory_uri().'/css/main.css',array(),'2.7.1');

$theme_style = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('theme_style_picker') :  'light';
if( $theme_style == 'dark' ) {
    wp_enqueue_style('kerge-dark-styles', get_template_directory_uri().'/css/dark-styles.css',array(),'2.7.2');
}

if ( is_page_template( 'page-templates/template-kerge-vcard-one-page.php' ) ) {
	wp_enqueue_style('kerge-one-page-styles', get_template_directory_uri().'/css/one-page-styles.css',array(),'2.7.2');
}

wp_enqueue_style('kerge-customization', get_template_directory_uri().'/css/customization.css',array(),'2.7.2');
...
if ( is_page_template( 'page-templates/template-kerge-vcard.php' ) ) {
    wp_enqueue_script('page-animations', get_template_directory_uri().'/js/page-animations.js',array(),'2.7.2',true);
}

if ( is_page_template( 'page-templates/template-kerge-vcard-one-page.php' ) ) {
    wp_enqueue_script('page-scroll-to-ids', get_template_directory_uri().'/js/jquery.malihu.PageScroll2id.min.js',array(),'1.6.3',true);
    wp_enqueue_script('one-page', get_template_directory_uri().'/js/one-page.js',array(),'2.7.2',true);
}

wp_enqueue_script('kerge-jquery-main', get_template_directory_uri().'/js/main.js',array(),'2.7.2',true);
